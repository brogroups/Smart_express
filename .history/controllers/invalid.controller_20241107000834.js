...
module.exports.createInvalid = async (req, res) => {
    try {
        ...
        // Optional: Validate the worker IDs exist
...
module.exports.getInvalidById = async (req, res) => {
    try {
        const { id } = req.params
        const invalid = await InvalidModel.findById(id).populate('workers')
...
module.exports.getAllInvalids = async (req, res) => {
    try {
